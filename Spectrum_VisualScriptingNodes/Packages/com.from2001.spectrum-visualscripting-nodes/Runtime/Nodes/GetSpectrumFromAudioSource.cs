...
{
    [UnitTitle("Get audio spectrum from AudioSource")]
    [UnitShortTitle("Spectrum from AudioSource")]
    [UnitCategory("Audio/Spectrum")]
    [UnitSubtitle("Get audio spectrum from AudioSource")]
    public class GetSpectrumFromAudioSource : Unit
    {
        [DoNotSerialize]
        ...
        protected override void Definition()
        {
            ...
            audioSource = ValueInput<AudioSource>("audioSource", null).NullMeansSelf();
        ...
        {
            AudioSource audioSource = flow.GetValue<AudioSource>(this.audioSource);
